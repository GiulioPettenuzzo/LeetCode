...
<div id="navbar-gemfu" style="z-index: -3;">
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
   ...
   <br>
	...
	<div class="all-screen-lv5" onclick="LoadIndexbyLoginUser()">
  
  </div>
     <div class="container-fluid col-md-4 internal-div" id="register-div">
    <nav class="navbar navbar-expand navbar-dark bg-dark">
      <h1 id="reg">User Login</h1>
    </nav>
	...
	<c:choose>
    	<c:when test='${not empty users && !message.error}'>
			<c:forEach var="us" items="${users}">
				<ul id="done">
					<img src="${us.profileImage}" class="reg_img" id="profileImage">
				
					<li><h5 >username:</h5> <div id="username" ><c:out value="${us.username}"/></div></li>
					<li><h5 >name: </h5><div id="name"><c:out value="${us.name}"/></div></li>
					<li><h5 >surname: </h5><div id="surname"><c:out value="${us.surname}"/></div></li>
					<li><h5 >date: </h5><div id="date"><c:out value="${us.date}"/></div></li>
					<li><h5 >gender: </h5><div id="gender">
                                                <c:choose>
					...
					<li><h5 >email: </h5><div id="email"><c:out value="${us.email}"/></div></li>
		...
		<c:otherwise>	
			<h5 class="myh5" style="margin-left: 5vw">Username or password wrong!</h5>
		</c:otherwise>
	</c:choose>
		<nav id="bottom-reg" class="navbar navbar-expand navbar-dark bg-dark justify-content-end">
			<button class="btn btn-light reg-btn" href="WebContent/index.html" onclick="LoadIndexbyLoginUser()"><b>close</b></button>
		</nav>
	</div>
