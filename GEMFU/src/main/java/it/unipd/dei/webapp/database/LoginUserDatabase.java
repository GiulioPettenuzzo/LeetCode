 ...
 * @since 1.00
 */
public final class LoginUserDatabase {

	/**
	 * The SQL statement to be executed
	 */
	private static final String STATEMENT = "SELECT username, name, surname, date, gender, email, profileimage, password FROM users WHERE username = ? AND password = ? ";
	...
	public LoginUserDatabase(final Connection con, final String username, final String password) {
		this.con = con;
	 ...
	 */
	public List<User> LoginUser() throws SQLException {
