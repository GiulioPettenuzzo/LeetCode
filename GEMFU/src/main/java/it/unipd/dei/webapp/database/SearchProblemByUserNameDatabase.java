 ...
 * @since 1.00
 */
public final class SearchProblemByUserNameDatabase {

	/**
	 * The SQL statement to be executed
	 */
	private static final String STATEMENT = "SELECT id, username, title, description, difficulty, solution, date FROM problem WHERE username = ?";
	...
	public SearchProblemByUserNameDatabase(final Connection con, final String username) {
		this.con = con;
	 ...
	 */
	public List<Problem> SearchProblemByUserName() throws SQLException {
